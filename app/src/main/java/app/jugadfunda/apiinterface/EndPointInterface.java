...
public interface EndPointInterface {
    ...
    @FormUrlEncoded
    Call<VerifyOtpResponse> wsVerifyOtp(@Field("mb")String mMobileNumber,@Field("fname")String mFirstname, @Field("lname")String mLastname, @Field("e")String mEmail, @Field("iname")String mInstituteName, @Field("qzid")long mQuizId);
}
