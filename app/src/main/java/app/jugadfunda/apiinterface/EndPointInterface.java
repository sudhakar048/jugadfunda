...
public interface EndPointInterface {
    ...
    @FormUrlEncoded
    Call<String> wsGenerateOtp(@Field("mb")String mMobileNumber);

    @POST("STBI/VerifyOtpController")
    @FormUrlEncoded
    Call<Boolean> wsVerifyOtp(@Field("mb")String mMobileNumber, @Field("otp")String mOtp,@Field("fname")String mFirstname,@Field("lname")String mLastname,@Field("e")String mEmail,@Field("iname")String mInstituteName, @Field("qzid")long mQuizId);
}
