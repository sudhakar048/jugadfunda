...
import app.jugadfunda.track.ZoomImageActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.iv_happy:
                ...
                mImplCartoonCornerPresenter.wsAddEmoji(funId, 1, emailid);
                break;
            case R.id.iv_satisfied:
                checkEnableAndDisable(2);
                mImplCartoonCornerPresenter.wsAddEmoji(funId, 2, emailid);
                break;
            case R.id.iv_unhappy:
                checkEnableAndDisable(3);
                mImplCartoonCornerPresenter.wsAddEmoji(funId, 3, emailid);
                break;
            case R.id.iv_sad:
                checkEnableAndDisable(4);
                mImplCartoonCornerPresenter.wsAddEmoji(funId, 4, emailid);
                break;
