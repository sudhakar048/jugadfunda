...
public class ImplCaptureIdeaPresenter  implements CaptureIdeaInterfaceImpl{
    ...
    @Override
    public void wsCaptureIdea(String mDay, String mTitle, String mDescription, String mUnique, String mBetter, String mFProof, String mTriggered, String mFProofOther, String mPSolving, long mUserId, MultipartBody.Part mImage, String mType, int pos) {
        ...
        try {
            ...
            rbmType=RequestBody.create(MediaType.parse("multipart/form-data"), URLEncoder.encode(mType,"UTF-8"));
