...
import app.jugadfunda.home.adapter.CaptureIdeaAdapter;
...
public class CaptureFragment extends Fragment implements CaptureIdeaInterfaceView{
    ...
    void initializeData(){
        ...
        mEmailId = sh.getString("emailid","");

        mList = jfStorage.getAllRecords(mEmailId);
        if(mList.isEmpty()){
            resetData(1);
        }
    }
    ...
    void resetData(int check){
        CaptureIdeaPojo monday = new CaptureIdeaPojo("Monday","","","","","","","","",null,"", mEmailId);
        CaptureIdeaPojo tuesday = new CaptureIdeaPojo("Tuesday","","","","","","","","",null, "",mEmailId);
        CaptureIdeaPojo wednessday = new CaptureIdeaPojo("Wednessday","","","","","","","","",null,"", mEmailId);
        CaptureIdeaPojo thursday = new CaptureIdeaPojo("Thursday","","","","","","","","",null,"", mEmailId);
        CaptureIdeaPojo friday = new CaptureIdeaPojo("Friday","","","","","","","","",null,"", mEmailId);
        CaptureIdeaPojo saturday = new CaptureIdeaPojo("Saturday","","","","","","","","",null, "",mEmailId);
        CaptureIdeaPojo sunday = new CaptureIdeaPojo("Sunday","","","","","","","","",null, "",mEmailId);
        if(check == 1){
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        if(cp.getAttachfile() != null){
                            File mFile = new File(cp.getImageuri());
                        ...
                        mImplCaptureIdeaPresenter.wsCaptureIdea(cp.getDay(), cp.getIdeatitle(), cp.getDescription(), cp.getUnique(), cp.getBetter(), cp.getFutureproof(), cp.getTriggered(), cp.getFutureproofotherways(), cp.getProblemsolving(), mUserId, fileToUpload, mType, pos);
